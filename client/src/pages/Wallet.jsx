...
export default function Wallet() {
  ...
  return (
    <div className="max-w-2xl mx-auto py-8">
      <h1 className="text-2xl font-bold text-[var(--color-zxaaa-text)] mb-6">Wallet</h1>
      <div className="rounded-2xl p-6 mb-6" style={{ background: 'linear-gradient(135deg, rgba(124,58,237,0.15), rgba(37,99,235,0.1))', border: '1px solid rgba(124,58,237,0.3)' }}>
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            ...
            <p className="text-3xl font-black text-[var(--color-zxaaa-text)]">₹{(user?.walletPoints || 0).toLocaleString('en-IN')}</p>
          </div>
        </div>
