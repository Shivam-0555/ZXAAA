  ...
  if (!user) {
    return (
      <div className="flex flex-col items-center justify-center py-20">
        ...
        <h2 className="text-2xl font-bold text-[var(--color-zxaaa-text)] mb-2">Login Required</h2>
      ...
      <div className="relative overflow-hidden rounded-[24px] p-8 md:p-12 shadow-2xl" style={{ background: 'var(--color-zxaaa-card)', border: '1px solid var(--color-zxaaa-border)' }}>
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
          <div>
            ...
            <h1 className="text-4xl md:text-5xl font-black text-[var(--color-zxaaa-text)] mb-3">Swap Center</h1>
          ...
          <button
            ...
            className={`shrink-0 flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-bold transition-all border ${
              activeTab === tab.id
                ...
                : 'bg-[var(--color-zxaaa-card)] border-[var(--color-zxaaa-border)] text-[var(--color-zxaaa-muted)] hover:text-[var(--color-zxaaa-text)] hover:border-[var(--color-zxaaa-primary-glow)]'
            }`}
          >
            {tab.label}
            {tab.icon}
      ...
      <div className="space-y-6">
        {loading ? (
          ...
          <div className="glass-panel p-12 rounded-3xl text-center border border-[var(--color-zxaaa-border)] flex flex-col items-center">
            ...
            <h3 className="text-2xl font-bold text-[var(--color-zxaaa-text)] mb-2">No {activeTab !== 'ALL' ? activeTab.toLowerCase() : ''} swaps found.</h3>
                  ...
                  <div className="p-6 md:p-8">
                    <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
                      ...
                      <div className="flex-1 w-full relative">
                        ...
                        <div className="p-4 rounded-xl border-2 border-[var(--color-zxaaa-border)] bg-[var(--color-zxaaa-card2)] flex gap-4">
                           ...
                           <div className="min-w-0 flex-1">
                             <h4 className="text-[var(--color-zxaaa-text)] font-bold truncate">{myProduct?.title || 'Unknown Product'}</h4>
                      ...
                      <div className="flex-1 w-full relative">
                        ...
                        <div className="p-4 rounded-xl border-2 border-[var(--color-zxaaa-border)] bg-[var(--color-zxaaa-card2)] flex gap-4">
                           ...
                           <div className="min-w-0 flex-1">
                             <h4 className="text-[var(--color-zxaaa-text)] font-bold truncate">{theirProduct?.title || 'Unknown Product'}</h4>
